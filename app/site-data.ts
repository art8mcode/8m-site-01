...
> = {
  project: [
    {
      ...
      supporting:
        'Фінальний обсяг залежить від задачі, необхідного дослідження, кількості каналів і необхідності запуску рекламних кампаній.',
      deliverables: [
        'Strategy',
        'Positioning',
        'Campaign structure',
    ...
    },
    {
      ...
      supporting:
        'Вартість залежить від кількості роликів, pre-production, кількості знімальних днів, складності зйомки та post-production.',
      deliverables: [
        'Creative concept',
        'Pre-production',
        'Shooting',
    ...
    },
    {
      ...
      supporting:
        'Обсяг роботи, команда та бюджет формуються після короткого брифу і знайомства із задачею.',
      deliverables: [
        'Strategy',
        'Content system',
        'Production',
  ...
  monthly: [
    ...
    },
    {
      ...
      supporting:
        'Фінальний обсяг і бюджет залежать від кількості контенту, production-обсягу, рекламної активності та задач бренду.',
      deliverables: [
        'Strategy',
        'Content system',
        'Production',
...
export const principles = [
  ...
  [
    'Одна система',
    'Стратегія, контент і просування можуть працювати в одному циклі — від першої ідеї до запуску, аналізу результату та наступної ітерації.',
  ],
];
export const faqs = [
  [
